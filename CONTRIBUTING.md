...
Rust Discord bot for the 6b6t community. For build commands, code style, and agent instructions, see [AGENTS.md](AGENTS.md).

## Setup

Clone the repo, then: `cargo build` and `cargo test`.
